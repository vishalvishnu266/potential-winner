...
const ta: Messages = {
    ...
    local: {
        ...
        subtitle: 'அருகில் உள்ள கடைகள், சேவைகள் மற்றும் சலுகைகள்',
        empty: 'இப்போது அருகில் சலுகைகள் இல்லை.',
        wantToList: 'உங்கள் கடையை இங்கு சேர்க்க வேண்டுமா?',
        contactUs: 'எங்களைத் தொடர்பு கொள்ளவும்',
        seeAllLocal: 'அனைத்து உள்ளூர் சலுகைகளையும் பார்',
        offer: 'சலுகை',
    },
