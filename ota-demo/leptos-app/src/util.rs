...
/// Base URL of the OTA server. Point this at your dev machine's static
/// LAN IP (or a stable hostname / tunnel URL). Update via
/// `./set-ota-url.sh http://<host>:<port>` if you'd rather not hand-edit.
///
/// No trailing slash — callers use `format!("{SERVER}{path}")` where
