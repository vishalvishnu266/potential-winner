...
// package pre-bundling, __APP_*__ compile-time globals, APP_ACCENT
// validation, APP_VERSION stamping) live in @pkg/vite-config.
//
// Env vars honoured (all optional):
//   APP_ENV      = mock | dev | prod   (default: mock)
//   APP_VERSION  = string              (default: pkg.version+UTC-timestamp)
//   APP_ACCENT   = indigo|violet|sky|emerald|amber|rose|slate  (default: indigo)
